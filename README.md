...
【新功能】
新增对话导出功能，支持将当前 AI 对话导出为 Markdown、Obsidian Markdown、TXT、JSON 等格式，便于对话内容归档、知识沉淀和后续复用。用户可在对话页面快速导出当前会话，并支持复制到剪贴板或下载为本地文件。

【功能优化】
优化多平台适配能力，增强插件对豆包、千问、DeepSeek 等国产大模型平台的兼容性，提升对话内容识别、角色判断和导出完整性，进一步改善不同 AI 平台下的使用体验。
